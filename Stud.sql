...
INSERT INTO `university`.`groupps` (`gr_id`, `gr_name`) VALUES ('2', 'S');
  ...
  CREATE TABLE `university`.`directors` (
...
INSERT INTO `university`.`directors` (`id`, `name`, `surname`, `phone_number`, `gr_id`) VALUES ('1', 'FFF', 'w45uyh', '322223322', '1');
INSERT INTO `university`.`directors` (`id`, `name`, `surname`, `phone_number`, `gr_id`) VALUES ('2', 'dsdfs', 'rthyhy', '231456', '1');
INSERT INTO `university`.`directors` (`id`, `name`, `surname`, `phone_number`, `gr_id`) VALUES ('3', 'sdfg', 'thty6tf', '1234567890', '2');